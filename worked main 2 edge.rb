...
module RoundMe
  ...
  unless file_loaded?(__FILE__)
    cmd_round_vertex = UI::Command.new('Round Corner') do
      Sketchup.active_model.select_tool(RoundMe::FilletTool.new(:edge))
    end
    cmd_round_vertex.small_icon = 'x_round.pdf'
    cmd_round_vertex.large_icon = 'x_round.pdf'
    cmd_tcmd_round_vertexool.tooltip = 'Interactive Round Tool'

    cmd_round_face = UI::Command.new('Round Face') do
      Sketchup.active_model.select_tool(RoundMe::FilletTool.new(:face))
    end
    cmd_round_face.small_icon = 'x_round.pdf'
    cmd_round_face.large_icon = 'x_round.pdf'
    cmd_round_face.tooltip = 'Round Selected Face'
    ...
    menu.add_item(cmd_round_vertex)
    menu.add_item(cmd_round_face)
    menu.add_item(cmd_reload)

    tb = UI::Toolbar.new('RoundMe')
    tb.add_item(cmd_round_vertex)
    tb.add_item(cmd_round_face)
